...
public class ElasticWarehouseSummary extends ElasticWarehouseRestHandler {

	protected Settings settings_;
	//protected RestController controller_;
	protected Client client_;
	
	private ElasticWarehouseAPIProcessorSummary processor_ = null;
	private ElasticWarehouseTasksManager tasksManager_ = null;
	
    @Inject public ElasticWarehouseSummary(Settings settings, Client client, RestController controller) {
        ...
        controller.registerHandler(GET, "/_ewsummary", this);
    ...
    public void handleRequest(final RestRequest orgrequest, final RestChannel channel, final Client client)
    {
    	...
    	ElasticWarehouseAPIProcessorSummaryParams params = processor_.createEmptyParams();
