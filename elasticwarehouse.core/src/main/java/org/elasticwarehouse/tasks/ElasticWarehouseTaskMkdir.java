...
public class ElasticWarehouseTaskMkdir extends ElasticWarehouseTask {
	...
	public ElasticWarehouseTaskMkdir(ElasticSearchAccessor acccessor, ElasticWarehouseConf conf, String folder) {
		super(acccessor, conf);
		conf_ = conf;
		targetfolder_ = folder;
	}
	
	public ElasticWarehouseTaskMkdir(ElasticSearchAccessor acccessor, ElasticWarehouseConf conf, Map<String, Object> source)
	{
	...
	public void start()
	{
		try {
			...
			FolderToolsResult result = toolset.createFolder(targetfolder_);
