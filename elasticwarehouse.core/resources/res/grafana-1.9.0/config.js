  ...
  return new Settings({
      ...
      */
      ...
      datasources: {
        graphite: {
          type: 'graphite',
	  /*url: "http://<<GRAPHITEHOSTWITHPORT>>",*/
          /*url: window.location.protocol+"//"+window.location.hostname+":"+window.location.port+"/_graphite",*/
	  url: window.location.protocol+"//"+window.location.hostname+":<<GRAPHITEPORT>>",
          default: true,
          render_method: 'GET'
        },
        elasticsearch: {
          type: 'elasticsearch',
          url: "http://<<ESHOSTWITHPORT>>",
          index: 'grafana-dash',
          grafanaDB: true
        }
      },
      ...
      */
      ...
      default_route: '/dashboard/db/elasticwarehouse',
